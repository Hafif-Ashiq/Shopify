...
public class creditCard extends textFields{

    private JFrame frame;
    private ImageIcon image;
    protected Text_Fields t1;
    // Default Constructor
    public creditCard(){
    ...
    public creditCard(int width, int height, int R, int G, int B, String title, String location){
        ...
        frame.add(b2.setButton(565, 520, 150, 60, "Verify", "Fonts\\Montserrat-Bold.ttf", 18f, 255, 248, 238, 249, 165, 20));
        ...
        // UserName
        t1 = new Text_Fields();
        frame.add(t1.TF(408, 223, 60, 522, "XXXX-XXXX-XXXX-XXXX"));
        // Password
        Text_Fields t2 = new Text_Fields();
        frame.add(t2.TF(408, 405, 60, 250, "XX/XX"));
        // Confirm Password
        ...
        t1.panels(this.frame, 408, 141, 210, 60, 249, 165, 20, "Card Number", "Fonts\\Montserrat-Bold.ttf", 16f);
        t1.panels(this.frame, 408, 323, 160, 60, 249, 165, 20, "Expiry Date", "Fonts\\Montserrat-Bold.ttf", 16f);
        t1.panels(this.frame, 683, 323, 100, 60, 249, 165, 20, "CVC", "Fonts\\Montserrat-Bold.ttf", 16f);
